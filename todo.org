...
**** Briggs
     ...
     - Si en fusionnant a et b dans G, le nombre de noeuds voisin du
...
***** Briggs
      ...
      il va en rester un nombre strictement inférieur à k dont le noeud
   ...
   colorize G colors =
     ...
     - there are two nodes a and b that love each other.
       if briggs or georges give their blessing then
         ...
         colorize (divorce a b in G) colors
